...
#define MotorI_A 48   //Direccion de los motores Izquierdos A: 52->48
#define MotorI_B 49   //Direccion de los motores Izquierdos B: 53->49
  ...
  if (millis() - timeold >= 10){
    ...
    //Filtro por el disparo de encoders
      ...
      if(abs(ContM1)>tol*minIzq)
        ContM1 = (ContM1<0)?-minIzq:minIzq;   //Operador ternario
